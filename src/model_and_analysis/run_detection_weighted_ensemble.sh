...
SCORES_TRAINING_DIR=$DATA_DIR"results/scores_training/weighted_ensemble/"
FEATURE_IMPORTANCE_DIR=$DATA_DIR"results/feature_importance_coefficients/"
...
OUTPUT_DIR=$DATA_DIR"results/ensemble_models/weighted_ensemble_detection/"
